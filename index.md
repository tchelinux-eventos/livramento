[![Tchelinux 2019 Sant'Ana do Livramento](images/banner.jpg)](#)
...
| **09:30** | [**Git em pequenos projetos**](#) <br> <span class="label label-success">Principiante</span> <br> Sandro Custódio|
| **10:15** | [**Backup com Clonezilla**](#) <br> <span class="label label-success">Principiante</span> <br> Gill Velleda Gonzales|
| **11:00** | [**Apresentação do framework Laravel**](#) <br> <span class="label label-success">Principiante</span> <br> Kevin Maciel Medeiros|
| **11:45** | [**Introdução ao desenvolvimento Android com Kotlin**](#) <br> <span class="label label-success">Principiante</span> <br> Ricardo Robaina |
| **12:30** <td colspan=5><center>**Intervalo para Almoço**</center> |
| **14:00** | [**Fugindo para as Colinas Com Python**](#) <br> <span class="label label-success">Principiante</span> <br> Julio Biason|
| **14:45** | [**...porque no MEU TEMPO!**](#) <br> <span class="label label-success">Principiante</span> <br> Fabio Beneditto|
| **15:30** <td colspan=5><center>**Coffee-Break**</center> |
| **16:00** | [**De a cara a tapa: Como se destacar no mercado de trabalho **](#) <br> <span class="label label-success">Principiante</span> <br> Jerônimo Medina Madruga|
| **16:45** | [** **](#) <br> <span class="label label-success">Principiante</span> <br> |
...
### Apresentação do framework Laravel
...
### De a cara a tapa: Como se destacar no mercado de trabalho
